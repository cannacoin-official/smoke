...
Smoke is the name of open source software which enables the use of this currency. It takes Smoke to the next level by building upon
Bitcoin Core 0.13.2 with some patches from newer Bitcoin Core versions to offer performance enhancements, wider compatibility with third party services and a more advanced base.

For more information, as well as an immediately useable, binary version of the Smoke software, see https://cannacoin.org.

License
-------

Smoke is released under the terms of the MIT license. See [COPYING](COPYING) for more
