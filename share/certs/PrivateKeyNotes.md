...
unlocked to sign the Smoke-Qt.app bundle.
...
allowing somebody to distribute a Smoke-Qt.app or smoke-qt-setup.exe with a valid
...
that the smoke-qt.exe file inside the installer had not been tampered with.
