...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_valid)
{
    static const std::string CASES[] = {
        "prefix:x64nx6hz", "PREFIX:X64NX6HZ", "p:gpf8m4h7", "smoke:qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn",
        "smoketest:testnetaddress4d6njnut", "smokereg:555555555555555555555555555555555555555555555udxmlmrz",
    };
...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_invalid)
{
    static const std::string CASES[] = {
        ...
        "smokereg:555555555555555555x55555555555555555555555555udxmlmrz",
        "smokereg:555555555555555555555555555555551555555555555udxmlmrz", "pre:fix:x32nx6hz", "prefixx64nx6hz",
    };
...
BOOST_AUTO_TEST_CASE(cashaddr_testvectors_noprefix)
{
    static const std::pair<std::string, std::string> CASES[] = {
        {"smoke", "qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn"}, {"prefix", "x64nx6hz"}, {"PREFIX", "X64NX6HZ"},
        {"p", "gpf8m4h7"}, {"smoke", "qpzry9x8gf2tvdw0s3jn54khce6mua7lcw20ayyn"},
        {"smoketest", "testnetaddress4d6njnut"}, {"smokereg", "555555555555555555555555555555555555555555555udxmlmrz"},
    };
