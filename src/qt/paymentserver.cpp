...
const QString BITCOIN_IPC_PREFIX("smoke:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/smoke-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/smoke-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/smoke-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click smoke: links
...
//
// OSX-specific way of handling smoke: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in smoke: URIs
