...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s smoke-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  smoke-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded smoke transaction") + "\n" +
              "  smoke-tx [options] -create [commands]   " + _("Create hex-encoded smoke transaction") + "\n" +
              "\n";
