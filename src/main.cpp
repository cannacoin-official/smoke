...
#if defined(NDEBUG)
# error "Smoke cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Smoke Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Smoke also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Smoke also requires low S in sigs
