 ...
 * between smoked, and smoke-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/grasshaussoftware/smoke>";
    const std::string URL_WEBSITE = "<https://cannacoin.org/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Smoke Developers", 2025)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Smoke useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Smoke More version %s\n", FormatFullVersion());
}
