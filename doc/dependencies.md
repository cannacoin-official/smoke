...
These are the dependencies currently used by Smoke. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/smokenl
Keybase  - https://keybase.io/team/smoke/
