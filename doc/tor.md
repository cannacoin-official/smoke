...
Add these lines to your `/etc/tor/torrc` (or equivalent config file):
    ...
    HiddenServicePort 23414 127.0.0.1:23413

The directory can be different of course, but virtual port numbers should be equal to
your bitcoind's P2P listen port (23414 by default), and target addresses and ports
...
and open port 23414 on your firewall (or use port mapping, i.e., `-upnp`).
